...
class FixQEqReax : public Fix {
 public:
  ...
  int matvecs;
  double qeq_time;
  double *q_vec; // Added by Itai for the iEL_Scf
 protected:
  int nevery,reaxflag;
  int n, N, m_fill;
  int m_fill_q; // Added by Itai for the iEL_Scf
  ...
  double tolerance_s;     // tolerance for the norm of the rel residual in CG
  double tolerance_t;     // tolerance for the norm of the rel residual in CG
  int i_tolerance_s;     // tolerance for the norm of the rel residual in CG
  int i_tolerance_t;     // tolerance for the norm of the rel residual in CG
  int tol_flag;
  ...
  sparse_matrix H;
  sparse_matrix H_q; // Added by Itai for the iEL_Scf
  double *Hdia_inv;
  double *Hdia_inv_q; // Added by Itai for the iEL_Scf
  double *b_s, *b_t;
  double *b_s_q; // Added by Itai for the iEL_Scf
  double *b_prc, *b_prm;

  //CG storage
  double *p, *q, *r, *d;
  double *p_q, *q_q, *r_q, *d_q; // Added by Itai for the iEL_Scf
  ...
  virtual void sparse_matvec(sparse_matrix*,double*,double*,double);
  ...
  int matvecs_q; //added by Itai for the iEL_Scf;
};
